                ...
                BYTES(b, 1, 80, 27, b, e, 0, 27) BYTES(c, 10, 0, 26, b, c, b, e)
                    BYTES(0, b, 0, 58, c, 1, 80, 27) BYTES(
                        ...
                        BYTES(b, 15, 0, 26, a, b, a, 42) BYTES(7, 3, 1, 36, 7,
                            ...
                            7, 7b, a) BYTES(b, 69, 6e, 73, 65, 72, 74, 9)
                            BYTES(6e, 61, 6d, 65, 8, 3e, 2c, a) BYTES(6, 3c, a,
                                70, 61, 69, 72, 73) BYTES(a, 74, 61, 62, 6c, 65,
                                9, 74) BYTES(79, 70, 65, 1, 0, 1, 9, 6e)
                                BYTES(61, 6d, 65, 8, 74, 6f, 70, 2) BYTES(
                                    27, 3, 0, 2, 0, 3, 0, 4) BYTES(36, 0, 0, 0,
                                    33, 1, 2, 0) BYTES(3d, 1, 1, 0, 4b, 0, 1, 0)
                                    BYTES(0, d, 74, 6f, 73, 74, 72, 69)
                                        BYTES(6e, 67, a, 74, 61, 62, 6c, 65)
