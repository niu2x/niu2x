...
TOLUA_API int tolua_isusertable(
    lua_State* L, int lo, const char* type, int def, tolua_Error* err);
...
TOLUA_API void tolua_function(
    lua_State* L, const char* name, lua_CFunction func);
TOLUA_API void tolua_constant(lua_State* L, const char* name, lua_Number value);
TOLUA_API void tolua_variable(
    lua_State* L, const char* name, lua_CFunction get, lua_CFunction set);
...
TOLUA_API void tolua_pushusertype_and_takeownership(
    lua_State* L, void* value, const char* type);
...
TOLUA_API void tolua_pushfieldnumber(
    lua_State* L, int lo, int index, lua_Number v);
TOLUA_API void tolua_pushfieldstring(
    lua_State* L, int lo, int index, const char* v);
TOLUA_API void tolua_pushfielduserdata(
    lua_State* L, int lo, int index, void* v);
...
TOLUA_API lua_Number tolua_tofieldnumber(
    lua_State* L, int lo, int index, lua_Number def);
TOLUA_API const char* tolua_tofieldstring(
    lua_State* L, int lo, int index, const char* def);
TOLUA_API void* tolua_tofielduserdata(
    lua_State* L, int lo, int index, void* def);
...
TOLUA_API void tolua_dobuffer(
    lua_State* L, char* B, unsigned int size, const char* name);
...
TOLUA_API int tolua_fast_isa(
    lua_State* L, int mt_indexa, int mt_indexb, int super_index);
