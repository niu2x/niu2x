    ...
    ImGuiTableFlags flags, const ImVec2& outer_size, float inner_width)
{
    ...
    if (use_child_window) {
        ...
        if (override_content_size.x != FLT_MAX
            ...
            SetNextWindowContentSize(ImVec2(override_content_size.x != FLT_MAX
...
float ImGui::TableGetMaxColumnWidth(const ImGuiTable* table, int column_n)
{
    ...
    const float min_column_distance = table->MinColumnWidth
        + table->CellPaddingX * 2.0f + table->CellSpacingX1
        + table->CellSpacingX2;
    if (table->Flags & ImGuiTableFlags_ScrollX) {
...
void ImGui::TableHeader(const char* label)
{
    ...
    if ((table->Flags & ImGuiTableFlags_Sortable)
        ...
        if (column->SortOrder != -1) {
            ...
            if (column->SortOrder > 0) {
                ...
                RenderText(
                    ImVec2(x + g.Style.ItemInnerSpacing.x, y), sort_order_suf);
                PopStyleColor();
                x += w_sort_text;
            }
    ...
    RenderTextEllipsis(window->DrawList, label_pos,
        ImVec2(
            ellipsis_max, label_pos.y + label_height + g.Style.FramePadding.y),
...
void ImGui::DebugNodeTable(ImGuiTable* table)
{
    ...
    if (IsItemHovered())
        GetForegroundDrawList()->AddRect(table->OuterRect.Min,
            table->OuterRect.Max, IM_COL32(255, 255, 0, 255));
