...
void Benchmark::MultipleAllocation(
    ...
    assert(
        allocationSizes.size() == alignments.size() &&
...
const BenchmarkResults Benchmark::buildResults(
    ...
    results.OperationsPerSec = results.Operations /
                               static_cast<double>(
                                   results.Milliseconds.count());
    results.TimePerOperation = static_cast<double>(
                                   results.Milliseconds.count()) /
