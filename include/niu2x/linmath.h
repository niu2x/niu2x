...
#define LINMATH_H_DEFINE_VEC(n)                                                \
    ...
    LINMATH_H_FUNC void vec##n##_scale(                                        \
        vec##n r, vec##n const v, float const s)                               \
    {                                                                          \
        int i;                                                                 \
        for (i = 0; i < n; ++i)                                                \
            r[i] = v[i] * s;                                                   \
...
LINMATH_H_FUNC void mat4x4_scale_aniso(
    mat4x4 M, mat4x4 const a, float x, float y, float z)
{
...
LINMATH_H_FUNC void mat4x4_frustum(
...
LINMATH_H_FUNC void mat4x4_ortho(
    mat4x4 M, float l, float r, float b, float t, float n, float f)
{
    M[0][0] = 2.f / (r - l);
    M[0][1] = M[0][2] = M[0][3] = 0.f;
...
LINMATH_H_FUNC void mat4x4_perspective(
    mat4x4 m, float y_fov, float aspect, float n, float f)
{
...
LINMATH_H_FUNC void mat4x4_look_at(
    mat4x4 m, vec3 const eye, vec3 const center, vec3 const up)
{
